...
### Разрешается:
- ✅ **Скачивать и запускать** код на своем компьютере для ознакомления и тестирования
- ✅ **Изучать** код с целью обучения и понимания подходов
- ✅ **Запускать** проект в локальной среде для личного использования

### Запрещается:
- ❌ **Использовать** код в коммерческих целях
- ❌ **Распространять** копии кода (в том числе измененные версии)
- ❌ **Публиковать** код (полностью или частично) на других ресурсах
- ❌ **Выдавать** код за свой собственный

### Отказ от ответственности:
> **Данный проект предоставляется "КАК ЕСТЬ" (AS IS) без каких-либо гарантий.**  
> Автор не несет ответственности за любой ущерб, прямой или косвенный, 
> возникший в результате использования или невозможности использования данного кода.  
> Использование кода осуществляется на **собственный страх и риск** пользователя.

### Использование в демонстрационных целях
Проект создан для демонстрации навыков разработки и не предназначен для 
продажи, включения в коммерческие продукты или использования в 
корпоративной среде без явного письменного разрешения автора.

---

© 2026 Ankh2625. Все права защищены.